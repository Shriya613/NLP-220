...
Original file is located at
    https://colab.research.google.com/drive/1M2vy-Z0FV1hKrSEB7zSzPLJqrnOaB9H5
...
def train_and_evaluate_log_reg(X_train, y_train, X_val, y_val, model_name):
...
train_and_evaluate_log_reg(X_train_count, y_train, X_test_count, y_test, "Logistic Regression with Bag of Words")
...
train_and_evaluate_log_reg(X_train_tfidf, y_train, X_test_tfidf, y_test, "Logistic Regression with Tf-Idf")
...
from sklearn.metrics import classification_report
train_and_evaluate_log_reg(X_train_ngram, y_train, X_test_ngram, y_test, "Logistic Regression with Word-based Bigrams")