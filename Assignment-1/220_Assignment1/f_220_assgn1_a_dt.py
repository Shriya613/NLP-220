...
Original file is located at
    https://colab.research.google.com/drive/1HlIi9oFW6jX42Ztu1Q9F3fSWzdrJGSqt
...
# Evaluate models
ngram_results = evaluate_model(dt_model, X_train_vec, X_test_vec, y_train, y_test)
...
bow_results = evaluate_model(dt_model, X_train_bow, X_test_bow, y_train, y_test)
...
tfidf_results = evaluate_model(dt_model, X_train_tfidf, X_test_tfidf, y_train, y_test)
